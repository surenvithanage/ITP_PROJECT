                            ...
                            <ul class="nav navbar-top-links navbar-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-user">
                                        <li><a href="#Modal" data-toggle="modal"  ><i class="fa fa-plus"></i> New Permission </a>
                                        <li><a href="#Modal1" data-toggle="modal"  ><i class="fa fa-plus"></i> New Role-Permission </a>
                                        </li>
                                    </ul>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <table class="table table-bordered table-responsive Table" id="Table">
                                        <thead>
                                        <tr>
                                            <th class="search">Permission ID</th>
                                        ...
                                        $results = mysqli_query($db ,"SELECT * FROM permissions");
...
?>
<?php
    include_once 'permission_modal_view.php';
    include_once 'rolePermission_modal_view.php';
?>
